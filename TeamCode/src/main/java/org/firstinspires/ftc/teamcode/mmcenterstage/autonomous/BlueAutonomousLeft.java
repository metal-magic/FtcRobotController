...
public class BlueAutonomousLeft extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       */
        ...
        armMotor.setPower(0);
<<<<<<< Updated upstream:TeamCode/src/main/java/org/firstinspires/ftc/teamcode/mmcenterstage/autonomous/BlueAutonomousLeft.java
        sleep(AutonomousUtility.SLEEP_TIME);
...
=======
        ...
        sleep(750);
        gripperServo1.setPosition(1);
>>>>>>> Stashed changes:TeamCode/src/main/java/org/firstinspires/ftc/teamcode/mmcenterstage/BlueAutonomousLeft.java
