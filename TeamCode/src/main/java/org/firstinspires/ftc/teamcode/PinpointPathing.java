...
public class PinpointPathing extends LinearOpMode {
    ...
    static final Pose2D TARGET_1 = new Pose2D(DistanceUnit.MM,706.8,194.7,AngleUnit.DEGREES,0);
    static final Pose2D TARGET_2 = new Pose2D(DistanceUnit.MM, 200.1, -658.139, AngleUnit.DEGREES, -138.13);
    static final Pose2D TARGET_3 = new Pose2D(DistanceUnit.MM,353.4,428.2, AngleUnit.DEGREES,90);
    static final Pose2D TARGET_4 = new Pose2D(DistanceUnit.MM,304.3, 1210, AngleUnit.DEGREES,90);
    static final Pose2D TARGET_5 = new Pose2D(DistanceUnit.MM,30.869,1659.946, AngleUnit.DEGREES,133.5);
