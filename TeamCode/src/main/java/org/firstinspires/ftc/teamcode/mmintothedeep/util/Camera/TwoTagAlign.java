...
@Autonomous
@Disabled
public class TwoTagAlign extends LinearOpMode{
...
//                .build();
     ...
     */
    private void telemetryAprilTag(int id1, int id2) {

        if (tagProcessor.getDetections().contains(id1) && tagProcessor.getDetections().contains(id2)) {

            int index1 = tagProcessor.getDetections().indexOf(id1);
            telemetry.addData("id1", index1);
            int index2 = tagProcessor.getDetections().indexOf(id2);
            telemetry.addData("id1", index2);
